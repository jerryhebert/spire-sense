...
public class RunStatsTests
{
    ...
    public void DrawReachesThePanel()
    {
        ...
        var text = OverlayText.Build(analysis, true, new CycleFigures(36, 23, 4.0, 7.5, Measured: true), default, default).ToString();
    ...
    public void TheSectionIsLabelledPerTurn()
    {
        ...
        var text = OverlayText.Build(analysis, true, new CycleFigures(36, 23, 4.0, 5.0, Measured: true), default, default).ToString();
    ...
    public void TheEstimateIsLabelledAndTheMeasurementIsNot()
    {
        ...
        var estimated = OverlayText.Build(analysis, true, new CycleFigures(10, 5, 3.0, 5.0, Measured: false), default, default).ToString();
        var measured = OverlayText.Build(analysis, true, new CycleFigures(10, 5, 3.0, 5.0, Measured: true), default, default).ToString();
